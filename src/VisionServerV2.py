    ...
    def process_image_opencv(self,image,result_objs,just_detect = False,area_threshold = 0,debug = False):
        ...
        if not just_detect:
            ...
            for obj in result_objs:
                ...
                enhance_gray = enhance_contrast(gray,upper_bound=THRESHOLD_VALUE,show=False)
                # 噪声也会增强，因此要滤波
        ...
        self.img_count += 1
        return pose_list
    def cal_rect_length_pixel(self,box):
        ...
        length = np.linalg.norm(point2-point3)
