...
def main():
    ...
    client.aubo.tf_tree.add_node("home", "world", cube0_pos_in_camera, rpy_to_quaternion(cube0_ori_in_camera))  # 块0加到tftree
    ...
    # client.aubo.robot.set_end_max_line_acc(0.05)
    # client.aubo.robot.set_end_max_line_velc(0.20) # 0.15
    # client.aubo.movel_relative(np.array([0,0,0]), np.array([0,0,-np.pi/2]),frame_name='gripper_center')  # 夹爪移动到物块1的另一侧安全位置
    # client.aubo.robot.set_end_max_line_acc(0.05)
    # client.aubo.robot.set_end_max_line_velc(0.05) # 0.15
    ...
    # 把块1装入块0
    client.aubo.movel_tf(cube0_pos_save,cube0_ori_in_camera,frame_name='gripper_center')  # 夹爪移动到物块0的上方
    client.aubo.robot.set_end_max_line_acc(0.05)
    client.aubo.robot.set_end_max_line_velc(0.05) # 0.15
    cube0_pos_insert = cube0_pos_grasp
    cube0_pos_insert[2] += 0.02  # 这个得调
    client.aubo.movel_tf(cube0_pos_insert, cube0_ori_in_camera, frame_name='gripper_center') # 夹爪移动到装配位
    client.gripper.open_gripper(speed=500)  # 夹爪打开
    client.aubo.movel_tf(cube0_pos_save,cube0_ori_in_camera,frame_name='gripper_center')  # 夹爪移动到物块0的上方
    ...
    Z_gripper2_ground = 18  # 夹爪在末端接触地面时，夹爪中心到地面的高度
    ...
    slot_offset = np.array([0.0, 0.0, 0.009])
